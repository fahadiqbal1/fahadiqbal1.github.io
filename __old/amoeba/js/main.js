(function ($) {
	...
	var pattern = t.generate(document.body.clientWidth + 150, document.body.clientHeight);
	$('.featured').attr('style', 'background-image: '+pattern.dataUrl);

	//slogan
	var shine = new Shine(document.getElementById('slogan'));
